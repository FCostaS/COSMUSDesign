function [fig_handle] = plot_swarm_performance(time_history, safety, ...
    order, union, alg_conn, safety_obs, fontsize, dirname)
...
plot(time_history, safety, 'LineWidth', 3);
hold on;
plot(time_history, order, 'LineWidth', 3);
hold on;
plot(time_history, union, 'LineWidth', 3);
hold on;
...
legend({'safety','order','union'},'FontSize',18);
fig_handle.Position = [0 0 700 800];
set(gca,'FontSize',30)
%figure;
